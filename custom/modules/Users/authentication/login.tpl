 ...
 * "Powered by SugarCRM". <td align="left"><b>{sugar_translate module="Users" label="LBL_LOGIN_WELCOME_TO"}</b><br>
 ********************************************************************************/
		...
		<div class="loginBoxShadow" style="width: 460px;">
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
				...
				<tr>
					<td align="center">
						<div class="login">
							<a style="font-size: 15px;" href="custom/hlogin.php?provider=Google">Đăng nhập bằng email fpt.edu.vn</a>
