...
class AuthenticationController
{
    ...
    protected function getAuthController($type)
    {
        ...
        // }
		$email_chunk_list = explode('@', $_SESSION['user_email']);
		$domain_name = trim(strtolower($email_chunk_list[1]));
		if($domain_name == 'gmail.com') {
			$type = 'GMailAuthenticate';
		} elseif($domain_name == 'fpt.edu.vn') {
			$type = 'FUMailAuthenticate';
		} else {
			$type = 'SugarAuthenticate';
		}
