...
class FUMailAuthenticate extends SugarAuthenticate {

    var $userAuthenticateClass = 'FUMailAuthenticateUser';
    var $authenticationDir = 'FUMailAuthenticate';

    /**
     * Constructs EmailAuthenticate
     * This will load the user authentication class
     *
     * @return FUMailAuthenticate
     */
    function FUMailAuthenticate() {
