...
$enabled_google = $settings_googlesignin->settings['googlesignin_config_enabled_google'];

if(!empty($enabled_google)){
$sugar_smarty->assign('GOOGLE_SIGNIN_URL',"https://accounts.google.com/o/oauth2/auth?redirect_uri=".$settings_googlesignin->settings['googlesignin_config_redirect_url']."&response_type=code&client_id=".$settings_googlesignin->settings['googlesignin_config_client_id']."&scope=https://www.googleapis.com/auth/userinfo.email+https://www.googleapis.com/auth/userinfo.profile&approval_prompt=force&access_type=offline");
}else
{
$sugar_smarty->assign('GOOGLE_SIGNIN_URL',"");
}
