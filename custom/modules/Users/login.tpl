...
/**
 *
 * SugarCRM Community Edition is a customer relationship management program developed byy
...
{literal}
<link href="/themes/SuiteP/css/font-awesome.css" rel="stylesheet">
<link href="/themes/SuiteP/css/bootstrap-social.css" rel="stylesheet">
{/literal}
<div class="p_login_top" style="background-color:rgba(39,47,84,1);padding: 10px 2% 10px 2%;    margin-top: -10px;
    float: left;
    width: 100%;">
		<a title="FPL" href="/" id="fpl-logo" style="display: block;background-image:url(../../../../../themes/SuiteP/images/p_login_logo.png);
...
<div class="p_login">
    ...
    <div id="loginform">
        ...
        {sugar_translate label="WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING"}
            ...
            {/foreach}
            <center><font size="5em" ></font></center>
            ...
            <br><br>
            <div class="input-group">
                {if !empty($GOOGLE_SIGNIN_URL)}
                <div id="dt_google_signin">
                    <a class="btn btn-block btn-social btn-google"href="{$GOOGLE_SIGNIN_URL}" title="Sign in with google"><i class="fa fa-google-plus"></i>Login With FPT Email</a>
                </div>
                {/if}     
            </div>
			<div class="input-group">
                {if !empty($DT_365_SIGNIN_URL)}
                <div id="dt_365_signin">
                    <a class="btn btn-block btn-social btn-odnoklassniki"href="{$DT_365_SIGNIN_URL}" title="Sign in with 365"><i class="fa fa-windows"></i>Login With FE Email</a>
                </div>
                {/if}     
            </div>
...
<div class="p_login_bottom" style="z-index:-1">
	<center>
		<a id="admin_options">&copy; FPT Education</a>
		<a id="powered_by">&copy; Powered By Poly</a>
	</center>
