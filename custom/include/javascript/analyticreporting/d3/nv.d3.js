// Backup sugar version of nv.d3
var _sugarOriginalNv = nv;
// Initialize analytic reporting nv.d3 version object
var arnv = {};
        ...
        selection.each(function(data) {
            ...
            if (showControls) {
                ...
                g.select('.nv-controlsWrap')
                    .datum(controlsData)
                    .attr('transform', 'translate(-30,' + (-margin.top) +')') // #3842 - Added translate -30 instead of 0
                    .call(controls);
            }
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            if (showControls) {
                ...
                g.select('.nv-controlsWrap')
                    .datum(controlsData)
                    .attr('transform', 'translate(0,' + (30-margin.top) +')')
                    .call(controls);
            }
...
nv.models.multiChart = function() {
    ...
    var margin = {top: 30, right: 20, bottom: 50, left: 60},
        ...
        useVoronoi = true,
        bars1stacked = false, // #3856
        bars2stacked = false // #3856
        ;
    ...
    var x = d3.scale.linear(),
        ...
        bars1 = nv.models.multiBar().stacked(bars1stacked).yScale(yScale1).hideable(false), // #3856
        bars2 = nv.models.multiBar().stacked(bars2stacked).yScale(yScale2).hideable(false), // #3856
    ...
    // #3856 [start] - Added setters for stacked bars
    chart.bars1stacked = function(_) {
        if (!arguments.length) return bars1stacked;
        bars1stacked = _;
        bars1.stacked(_);
        return chart;
    };

    chart.bars2stacked = function(_) {
        if (!arguments.length) return bars2stacked;
        bars2stacked = _;
        bars2.stacked(_);
        return chart;
    };
...
nv.models.pie = function() {
            ...
            if (showLabels) {
                ...
                pieLabels.select(".nv-label text")
                    ...
                    .text(function(d, i) {
                        ...
                        // #4545 [start] - Show percent addition
                        var percentAddition = '';
                        if(showPercents) {
                            label = label + ' ('+d3.format('%')(percent)+')';
                        }
                        // #4545 [end]
    ...
    // #4545 [start] - Show percents
    chart.showPercents = function(_) {
    if (!arguments.length) return showPercents;
    showPercents = _;
    showPercents = showPercents || false; // False default value
    return chart;
    };
    // #4545 [end]
...
// Set adnalytic reporting nv.d3
arnv = nv;
// Restore backuped sugar nv.d3
nv = _sugarOriginalNv;