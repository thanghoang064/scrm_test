(function webpackUniversalModuleDefinition(root, factory) {
    if(typeof exports === 'object' && typeof module === 'object')
        module.exports = factory(require("ard3"));
    else if(typeof define === 'function' && define.amd)
        define(["ard3"], factory);
    else if(typeof exports === 'object')
        exports["D3Funnel"] = factory(require("ard3"));
    else
        root["D3Funnel"] = factory(root["ard3"]);
      ...
      */
       ...
       */
            ...
            value: function _initialize(data, options) {
                ...
                this.margin = settings.chart.margin; // #4540
       ...
       */
            ...
            value: function _draw() {
                ...
                this.svg = _d2.default.select(this.selector)
                    //.append('svg') // #4540 - Removed duplicated svg element
                    .attr("class","nvd3-svg")
                    // .attr('width', this.width + this.margin.left + this.margin.right)
                    // .attr('height', this.height+ this.margin.top + this.margin.bottom)
                    // #4540 [start] - Add wrapper with margins
                    .append("g")
                      .attr("class", "nvd3 nv-wrap")
                      .attr("transform", "translate("+this.margin.left+", "+this.margin.top+")")
                    .append("g")
                        .attr("class", "nv-funnelChart")
                    // #4540 [end]
                    ;
      ...
      */
       ...
       */
            ...
            value: function getDefaultFormattedValue(value) {
                var valueFormat = d3.format(',.0f'); // #5878 remove decimal places and add thousand separators to funnel
                if(typeof chartView !== "undefined"){ // #5879 take the  format from user preferences if defined
                    return chartView.data.numberFormat(null, null, value);
                } else {
