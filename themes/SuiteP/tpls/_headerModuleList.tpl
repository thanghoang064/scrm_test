    ...
    <div class="container-fluid">
        ...
        <div class="desktop-toolbar" id="toolbar" >
            {if $USE_GROUP_TABS}
                <ul class="nav navbar-nav">
                    ...
                    {/foreach}
                          <li class="navbar-brand-container">
                            <a  class="dropdown-toggle grouptab" href="index.php?module=Leads&action=EditView&return_module=Leads&return_action=DetailView" style="    font-family: 'Lato', Lato, Arial, sans-serif;    text-transform: uppercase;    color: #fff;">Create Lead</a>
                    </li>
            ...
            {/literal}
            {* <a href="index.php?module=Leads&action=EditView&return_module=Leads&return_action=DetailView" style="float: right;line-height: 60px;font-size: 13px;color: white;text-transform: uppercase;font-weight: bold;">{$APP.LBL_QUICK_CREATE}{sugar_translate module="Leads" label="LBL_MODULE_NAME"}</a> *}
        ...
        <div class="mobile-bar">
            ...
            <ul id="toolbar" class="toolbar">
                <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    <a style="color: white;"href="https://scrm.poly.edu.vn/index.php?module=fpoly_LeadImports&action=EditView">
                        CREATE LEAD <span class="glyphicon glyphicon-plus"></span>
                    </a>
                </li>
               <!-- <li id="quickcreatetop" class="create dropdown nav navbar-nav quickcreatetop">
                    ...
                    <div class="dropdown-menu" role="menu" aria-labelledby="searchbutton">
                        <form id="searchformdropdown" class="searchformdropdown" name='UnifiedSearch' action='index.php'
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control query_string" name="query_string" id="query_string" style="background-color:white"
        ...
        <div class="desktop-bar">
            <ul id="toolbar" class="toolbar">
                ...
                -->
                {* <li id="" class="dropdown nav navbar-nav navbar-search open">

                    <button style="visibility:hidden" id="searchbutton" class="dropdown-toggle btn btn-default searchbutton suitepicon suitepicon-action-search" data-toggle="dropdown" aria-expanded="false">
                    </button>
                    <div class="dropdown-menus" style="right: 40px;bottom: auto;left: auto;background-color: #534d64;min-width: 480px;min-height: 40px;height: 40px;overflow: visible;padding: 0;width: auto;    max-height: 200px;margin-top: 0;border-top-left-radius: 0;border-top-right-radius: 0;border-radius: 4px;z-index: 1000;position: absolute;font-size: 10px;background: #5d5670;" role="menu" aria-labelledby="searchbutton">
                        <form id="searchformdropdown" class="searchformdropdown" name='UnifiedSearch' action='index.php'
                              onsubmit='return SUGAR.unifiedSearchAdvanced.checkUsaAdvanced()'>
                            {search_controller}
                            <input type="hidden" class="form-control" name="module" value="Home">
