...
if (!class_exists('AsteriskIntegrationOutfitters'))
{

    class AsteriskIntegrationOutfitters
    {
        public static function isValid($thisModule = null, $user_id = null, $force_validation = false)
        {
            ...
            require('modules/' . $thisModule . '/outfittersconfig.php');
            ...
            $validated = AsteriskIntegrationOutfitters::doValidate($thisModule);
        ...
        public static function validate()
        {
            ...
            $validated = AsteriskIntegrationOutfitters::doValidate($currentModule, $_REQUEST['key']);
        ...
        public static function doValidate($thisModule, $key = null)
        {
            ...
            {
                $GLOBALS['log']->fatal('AsteriskIntegrationOutfitters::doValidate() failed: ' . print_r($response, true));
            }
        ...
        public static function change()
        {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('AsteriskIntegrationOutfitters::change() failed: ' . print_r($response, true));
            }
            else
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add()
        {
            ...
            $response = AsteriskIntegrationOutfitters::doValidate($currentModule);
