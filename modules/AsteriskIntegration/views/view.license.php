...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
            "<img border='0' align='absmiddle' src='{sugar_getimagepath file=\'eac_configuration_32.png'}\'>&nbsp;",
            "<a href='index.php?module=Administration&action=index' style='text-decoration:none'>" . translate('LBL_MODULE_NAME', 'Administration') . "</a>&nbsp;",
            translate('LBL_ASTERISK_INTEGRATION','AsteriskIntegration'),
            translate('LBL_ASTERISK_INTEGRATION_LICENSE','AsteriskIntegration')
        );
    }
    ...
    public function display()
    {
        ...
        require_once 'modules/' . $currentModule . '/outfittersconfig.php';
        ...
        $key = AsteriskIntegrationOutfitters::getKey($currentModule);
        ...
        $this->ss->assign("file_path", getJSPath("modules/" . $currentModule . "/jquery.min.js"));
        ...
        $this->ss->display('modules/' . $currentModule . '/outfitterslicense.tpl');
    }
    ...
    protected static function loadLicenseStrings()
    {
        ...
        foreach ($langs as $lang)
        {
            ...
            if (!@include ("modules/" . $currentModule . "/language/$lang.lang.php"))
            {
