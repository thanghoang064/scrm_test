...
if($_REQUEST['method'] == 'validate') {
    SMSOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    SMSOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    SMSOutfittersLicense::add();
    ...
    $validate_license = SMSOutfittersLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = SMSOutfittersLicense::doValidate($currentModule);
