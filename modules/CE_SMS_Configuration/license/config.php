...
$outfitters_config = array(
    'name' => 'CE_SMS_Configuration', //The matches the id value in your manifest file. This allow the library to lookup addon version from upgrade_history, so you can see what version of addon your customers are using
    'shortname' => 'sms-integration', //The short name of the Add-on. e.g. For the url https://www.sugaroutfitters.com/addons/sugaroutfitters the shortname would be sugaroutfitters
    'public_key' => '26c8f9064affce60cdbe1ee4710b62e5', //The public key associated with the group
