...
if(!class_exists('AnalyticReportingOutfittersLicense')) 
{
    class AnalyticReportingOutfittersLicense
    {
        /**
        ...
        public static function isValid($thisModule=null,$user_id=null,$force_validation=false)
        {
            ...
            // {
                ...
                // $elapsed = (7 * 24 * 60 * 60 * 999999999); //default to weekly
                // if($frequency == 'hourly') {
                    // $elapsed = (60 * 60 * 999999999);
                // } else if($frequency == 'daily') {
                    // $elapsed = (24 * 60 * 60 * 999999999);
                // }
            ...
            // $validated = AnalyticReportingOutfittersLicense::doValidate($thisModule);
        ...
        public static function validate()
        {
            ...
            $validated = AnalyticReportingOutfittersLicense::doValidate($currentModule,$_REQUEST['key']);
        ...
        public static function doValidate($thisModule,$key=null)
        {
            ...
            {
                $GLOBALS['log']->fatal('AnalyticReportingOutfittersLicense::doValidate() failed: '.print_r($response,true));
            }
        ...
        public static function change()
        {
            ...
            {
                header('HTTP/1.1 400 Bad Request');
                $GLOBALS['log']->fatal('AnalyticReportingOutfittersLicense::change() failed: '.print_r($response,true));
            } 
            else 
            {
                require_once('modules/Administration/Administration.php');
        ...
        public static function add()
        {
            ...
            $response = AnalyticReportingOutfittersLicense::doValidate($currentModule);
    ...
    class SugarOutfitters_API
    {
        ...
        public static function call($module,$path,$custom_data=array(),$method='post')
        {
            return array('success' => true,
                'result' => array('validated' => true,'ser_count' => 500,'licensed_user_count' => 550,'validated_users' => true));
