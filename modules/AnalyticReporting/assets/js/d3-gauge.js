(function(global) {
	...
	D3Gauge.prototype.write = function(value, transitionDuration) {
	  ...
	  // #5879 take the  format from user preferences if defined
	  var numberFormat = (new NumberFormatter(jQuery.extend({},{},ReportData.numberFormat), null)).makeFormatter();
	  centreFormat = function(value){ return numberFormat(null, null, value) };
	  needleContainer
		.selectAll('text')
	...
	D3Gauge.prototype._initGauge = function () {
	  this._gauge = d3.select(this._el)
		//.append('svg:svg')
		.attr('class', 'nvd3-svg') //#6261 Add nvd3-svg class to Guage chart for consistent rendering with other chart types, mainly size
		.append('g')
