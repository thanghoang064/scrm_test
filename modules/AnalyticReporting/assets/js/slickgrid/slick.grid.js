  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function finishInitialization() {
      if (!initialized) {
        ...
        // #5808 - Add extra scrollbar height to toolbar
        $paneHeaderL.height($paneHeaderL.height() + 15);
    ...
    function resizeCanvas() {
      ...
      // #4453, #5808 [start] - Before frozenColumns is set add space for scrollbars (this is not needed if autoHeight is false)
      if (options.frozenColumn == -1) {
          viewportTopH -= 10;
          paneTopH += 30;
      } else {
