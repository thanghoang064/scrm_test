...
class ViewLicense extends SugarView
{
    ...
    protected function _getModuleTitleParams($browserTitle = false)
    {
        ...
        return array(
           ...
           translate('LBL_DTGOOGLESIGNIN','Administration').': '.translate('LBL_DTGOOGLESIGNIN_LICENSE_TITLE','Administration'),
           );
    }
    ...
    public function display()
    {
        ...
        $key = GoogleSignInOutfittersLicense::getKey($currentModule);
