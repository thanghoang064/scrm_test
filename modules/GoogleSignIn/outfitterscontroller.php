...
require_once('modules/'.$currentModule.'/license/GoogleSignInOutfittersLicense.php');

if($_REQUEST['method'] == 'validate') {
    GoogleSignInOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    GoogleSignInOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    GoogleSignInOutfittersLicense::add();
    ...
    $validate_license = GoogleSignInOutfittersLicense::isValid($currentModule,$user_id,true);
    ...
    if($validate_license !== true) {
        ...
        $validated = GoogleSignInOutfittersLicense::doValidate($currentModule);
