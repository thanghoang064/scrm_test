...
<div class="container">
    <div class="row">
        <div class="col-md-8">
            ...
            <label for="securitygroups" style="padding-left:10px;padding-right:10px">Cơ sở :  Toàn quốc</label>
            <input type="hidden" id="securitygroups"   name="securitygroups" value="all">
...
var from,to;
  ...
  */
  ...
  $('#search').click(function(){
	...
	console.log(from);
	console.log(to);
	let url_path = `?module=PolyReports&action=voiceall&sec=${security_group}&telesale=all&from=${from}&to=${to}`
